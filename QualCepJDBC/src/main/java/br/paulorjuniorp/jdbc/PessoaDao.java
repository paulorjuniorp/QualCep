...
public class PessoaDao {
	...
	public void adiciona(Pessoa pessoa) {
		String sql = "insert into pessoas "
				+ "(id,cpf,nome,email,celular,id_logradouro,numero,complemento)" + " values (?,?,?,?,?,?,?,?)";
	...
	public Pessoa buscaPorNome(String nome){
		...
		try{
			PreparedStatement stmt = (PreparedStatement) connection.prepareStatement("select * from pessoas where nome=?");
